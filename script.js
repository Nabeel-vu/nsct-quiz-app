...
const SOUND_FILES = {
    ...
    optionSelect: [
        ...
        'are-you-out-of-your-mind-greenscreen-change-quality-and-end-wont-cut-off_2.mp3',
        'baat-to-sahi-hai.mp3',
        'bamboo-hit-sound-effect.mp3',
        'brother-ewwwwwww.mp3',
        'camera-flash-sound-effect.mp3',
        'confused-cross-eyed-kitten-meme.mp3',
        'correct.mp3',
        'cute-uwu.mp3',
        'downer_noise.mp3',
        'duck-toy-sound.mp3',
        ...
        'huh_37bAoRo.mp3',
        'ive-got-this.mp3',
        'japan-oppai-sound (1).mp3',
        'japan-oppai-sound.mp3',
        'kid-slap-oh.mp3',
        'koun-hai-re_8ep4nAR.mp3',
        'mac-quack.mp3',
        'man-screaming-aaaah.mp3',
        'maro-jump-sound-effect_1.mp3',
        'minecraft_hit_soundmp3converter.mp3',
        'money-soundfx.mp3',
        'movie_1.mp3',
        'mwahahaha.mp3',
        'nani-meme-sound-effect.mp3',
        'o-bhai-maro-mujhe-maro.mp3',
        'ohhhhh-no.mp3',
        'perfect-fart.mp3',
        'punch-gaming-sound-effect-hd_RzlG1GE.mp3',
        'roblox-death-sound_1 (1).mp3',
        'roblox-death-sound_1.mp3',
        'sanjay-dutt-nahi-meme-template-munna-bhai-mbbs-nahi.mp3',
        'shocked-sound-effect.mp3',
        'shocking_0NL2w3I.mp3',
        'slap-sound-effect-funny-memes.mp3',
        'smoochykiss.mp3',
        'surprise-shitpost-botom.mp3',
        'tl-b-bwbjy-1.mp3',
